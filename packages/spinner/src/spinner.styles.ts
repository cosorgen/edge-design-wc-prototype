...
import {
  curveEasyEase,
  smtcStrokeSpinnerBrandForeground,
  smtcStrokeSpinnerNeutralForeground,
  smtcStrokeSpinnerTrack,
  strokeWidthThick,
  strokeWidthThicker,
  strokeWidthThickest,
} from './spinner.tokens.js';
...
export const styles = css`
  ...
  .background {
    border: var(--indicatorSize) solid ${smtcStrokeSpinnerTrack};
    border-radius: 50%;
  }
  ...
  .indicator {
    color: ${smtcStrokeSpinnerBrandForeground};
  ...
  :host(${invertedState}) .indicator {
    color: ${smtcStrokeSpinnerNeutralForeground};
  }
