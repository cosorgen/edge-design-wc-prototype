...
export declare interface CopilotColorTokens {
  ...
  backgroundPageGradient: string;
  foregroundComposerInputHint: string;
  foregroundComposerInputRest: string;
}
...
export const copilotLightThemeColors: CopilotColorTokens = {
  ...
  backgroundControlSubtleHover: '#FFFFFF80',
  backgroundControlSubtlePressed: '#FFFFFF59',
  backgroundControlSubtleRest: 'transparent',
  backgroundControlSubtleSelected: '#FFFFFF00',
  controlFocusOuterStrokeColor: '#000000',
  controlFocusInnerStrokeColor: '#FFFFFF',
  foregroundControlNeutralPrimaryDisabled: '#33302E',
  foregroundControlNeutralPrimaryHover: '#33302E',
  foregroundControlNeutralPrimaryPressed: '#78726F',
  foregroundControlNeutralPrimaryRest: '#33302E',
...
export const copilotDarkThemeColors: CopilotColorTokens = {
  ...
  foregroundControlNeutralPrimaryDisabled: '#E4E6F1',
  foregroundControlNeutralPrimaryHover: '#F2DDCC',
  foregroundControlNeutralPrimaryPressed: '#BBA5A0',
  foregroundControlNeutralPrimaryRest: '#F2DDCC',
