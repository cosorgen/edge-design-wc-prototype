...
export const baseButtonStyles = css`
    ...
    :host {
        ...
        border: ${controlFocusInnerStrokeWidth} solid ${strokeControlOnNeutralGradientStop2Rest};
    ...
    :host(:focus-visible) {
        ...
        outline: ${controlFocusOuterStrokeWidth} solid
            ${nullColor3};
        box-shadow:
            ${shadow4},
    ...
    :host(${largeState}) {
        ...
        border-radius: var(--part-button-large-state-corner-radius, var(--rounded-border-radius));
    }
