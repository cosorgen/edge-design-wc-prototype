...
export function GenerateNeutralPalette(seedColor: string): NeutralColors {
  ...
  return {
    ...
    4: hexFromArgb(palette.tone(96)),
    8: hexFromArgb(palette.tone(92)),
    100: hexFromArgb(palette.tone(90)),
    104: hexFromArgb(palette.tone(86)),
    108: hexFromArgb(palette.tone(82)),
    150: hexFromArgb(palette.tone(85)),
    154: hexFromArgb(palette.tone(81)),
    158: hexFromArgb(palette.tone(78)),
    200: hexFromArgb(palette.tone(80)),
    250: hexFromArgb(palette.tone(75)),
    300: hexFromArgb(palette.tone(70)),
    304: hexFromArgb(palette.tone(66)),
    308: hexFromArgb(palette.tone(62)),
    350: hexFromArgb(palette.tone(65)),
    400: hexFromArgb(palette.tone(60)),
    404: hexFromArgb(palette.tone(56)),
    408: hexFromArgb(palette.tone(52)),
    450: hexFromArgb(palette.tone(55)),
    454: hexFromArgb(palette.tone(51)),
    458: hexFromArgb(palette.tone(48)),
    500: hexFromArgb(palette.tone(50)),
    550: hexFromArgb(palette.tone(45)),
    554: hexFromArgb(palette.tone(41)),
    ...
    704: hexFromArgb(palette.tone(26)),
    708: hexFromArgb(palette.tone(22)),
    750: hexFromArgb(palette.tone(25)),
    754: hexFromArgb(palette.tone(21)),
    758: hexFromArgb(palette.tone(18)),
    800: hexFromArgb(palette.tone(20)),
    804: hexFromArgb(palette.tone(16)),
    808: hexFromArgb(palette.tone(12)),
...
export function GenerateVibrantPalette(seedColor: string): VibrantColors {
  ...
  return {
    10: hexFromArgb(palette.tone(98)),
