  ...
  for (let i = 0, ii = attributes.length; i < ii; ++i) {
    ...
    if (parseResult === null) {
      if (includeBasicValues) {
        ...
        HTMLDirective.assignAspect(result, attr3.name);
      }
    } else {
...
var InlineTemplateDirective = class {
   ...
   */
  constructor(html3, factories2 = noFactories) {
    this.html = html3;
    this.factories = factories2;
  }
  /**
      ...
      get: function() {
        ...
        if (value === void 0) {
          ...
          if (respectConnection) {
            ...
            notifier.subscribe({ handleChange: handleChange3 }, "isConnected");
          }
        }
        return value;
      }
...
var spacingVerticalS = "var(--spacingVerticalS)";
...
var tabActiveBackgroundBlur = "var(--tabActiveBackgroundBlur)";
var tabActiveBackgroundLuminosity = "var(--tabActiveBackgroundLuminosity)";
var tabActiveBackgroundColor = "var(--tabActiveBackgroundColor)";
var tabActiveBackgroundNormal = "var(--tabActiveBackgroundNormal)";
...
__decorateClass([
  observable
], WindowsService.prototype, "transparency", 2);
__decorateClass([
  observable
...
var EdgeSerivce = class {
  constructor() {
    this.theme = "system";
    this.showFavoritesBar = "always";
    this.showSideBar = true;
  }
};
__decorateClass([
  observable
], EdgeSerivce.prototype, "theme", 2);
__decorateClass([
  observable
], EdgeSerivce.prototype, "showFavoritesBar", 2);
__decorateClass([
  observable
], EdgeSerivce.prototype, "showSideBar", 2);

// src/services/edgeWindowService.ts
...
var template5 = html`
  ...
  <div id="activeTab">
    ...
    <div id="content">
      ...
      <div class="row">
        <div class="column">
          ${(x) => x.es.showFavoritesBar === "always" ? html`<favorites-bar></favorites-bar>` : ""}
...
var MicrosoftEdge = class extends FASTElement {
  constructor() {
    super(...arguments);
    this.ews = new EdgeWindowSerivce();
  }
  connectedCallback() {
    super.connectedCallback();
    this.setTheme();
...
__decorateClass([
  inject(WindowsService)
], MicrosoftEdge.prototype, "ws", 2);
__decorateClass([
  inject(EdgeSerivce)
], MicrosoftEdge.prototype, "es", 2);
